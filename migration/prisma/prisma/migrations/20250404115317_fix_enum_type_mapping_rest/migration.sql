/*
  ...
  - Changed the type of `basedOn` on the `TrainingModels` table. No cast exists, the column would be dropped and recreated, which cannot be done if there is data, since the column is required.
...
DROP COLUMN "basedOn",
ADD COLUMN     "basedOn" "basedOn" NOT NULL,
