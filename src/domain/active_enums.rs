...
#[sea_orm(rs_type = "String", db_type = "Enum", enum_name = "SexEnum")]
pub enum Sex {
...
#[derive(
    Clone, Debug, Serialize, Deserialize, EnumIter, strum_macros::Display, DeriveActiveEnum,
)]
...
#[sea_orm(rs_type = "String", db_type = "Enum", enum_name = "TypeModel")]
pub enum TypeModel {
    #[sea_orm(string_value = "BasedRealPerson")]
