...
<head>
    ...
    <title>Reset Your {{options.website.website_basic_info.name}} Password</title>
    <!--[if mso]>
    <style type="text/css">
...
<body style="margin: 0 !important; padding: 0 !important; background-color: #f4f4f4;">
    ...
    <div class="preheader" style="display: none; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; font-size: 1px; line-height: 1px; color: #f4f4f4;">
        Reset your password for your {{options.website.website_basic_info.name}} account.
    </div>
          ...
          <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="max-width: 600px; background-color: #ffffff; border-collapse: collapse; border: 1px solid #dddddd; margin: 0 auto;">
            ...
            <tr>
              <td style="padding: 20px 30px 30px 30px; color: #333333; font-family: Arial, sans-serif; font-size: 16px; line-height: 1.5;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="center" style="margin: 0 auto 25px auto;">
                  <tr>
                    <td align="center" bgcolor="#007bff" style="border-radius: 5px;" class="button-link">
                      <a href="{{options.website.website_basic_info.site | safe}}/api/auth/magic/{{options.token}}" target="_blank" style="font-size: 16px; font-family: Arial, sans-serif; color: #ffffff; text-decoration: none; background-color: #007bff; border: 15px solid #007bff; border-radius: 5px; display: inline-block; font-weight: bold;">
                        Reset Your Password
                      </a>
                    </td>
                  </tr>
                ...
                <p style="margin: 0 0 25px 0; font-size: 12px; text-align: center; word-break: break-all;">
                  <a href="{{options.website.website_basic_info.site | safe}}/api/auth/magic/{{options.token}}" target="_blank" style="color: #007bff; text-decoration: underline;">
                    {{options.website.website_basic_info.site | safe}}/api/auth/magic/{{options.token}}
                  </a>
                </p>
            ...
            <tr>
              <td align="center" style="padding: 20px 30px; background-color: #eeeeee; color: #666666; font-family: Arial, sans-serif; font-size: 12px; line-height: 1.4;" class="footer">
                ...
                <p style="margin: 0 0 10px 0;">
                  {{options.company_address_line1}} <!-- Add your options.website.website_basic_info.name's physical address -->
                </p>
                ...
                -->
                 <p style="margin: 0;">
                   If you're having trouble with your account, please contact <a href="mailto:{{options.support_email}}" style="color: #666666; text-decoration: underline;">{{options.support_email}}</a>. <!-- Add support email -->
                 </p>
              </td>
            </tr>
            <!-- Footer Section : END -->
